...
namespace AssetBookmarker.Hierarchy
{
    ...
    /// メインのウィンドウ
    /// </summary>
    public class HierarchyBookmarkWindow : BookmarkWindowBase
    {
        ...
        void OnGUI()
        {
            ...
            EditorGUILayout.LabelField(MenuConfig.GUI_WINDOW_HIERARCHY_TEXT_OVERVIEW);
        ...
        private ReorderableList CreateSearchInfoList()
        {
            ...
            {
                headerRect = rect;
                EditorGUI.LabelField(rect, MenuConfig.GUI_WINDOW_HIERARCHY_TEXT_LIST_HEADER);
            };
        ...
        /// ウィンドウを開く
        /// </summary>
        [MenuItem(MenuConfig.GUI_MENU_TEXT_OPEN_BOOKMARK_HIERARCHY)]
        static void Open()
        {
            var window = GetWindow<HierarchyBookmarkWindow>();
            window.titleContent.text = MenuConfig.GUI_WINDOW_HIERARCHY_TEXT_TITLE;
            window.Repaint();
        }
        ...
        /// 選択オブジェクトを登録
        /// </summary>
        [MenuItem(MenuConfig.GUI_MENU_TEXT_REGISTER_HIERARCHY, false, 12)]
        ...
        /// </summary>
        [MenuItem(MenuConfig.GUI_MENU_TEXT_REGISTER_HIERARCHY, true)]
