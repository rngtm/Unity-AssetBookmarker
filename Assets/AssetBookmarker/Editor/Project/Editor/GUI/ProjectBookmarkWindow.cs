...
namespace AssetBookmarker.Project
{
    ...
    /// ブックマークの管理を行うウィンドウ
    /// </summary>
    public class ProjectBookmarkWindow : BookmarkWindowBase
    {
        /// <summary>
        /// Label領域の大きさ
        /// </summary>
        ...
        static private ReorderableList CreateBookmarkList(ProjectBookmarkData bookmarkData)
        {
            ...
            {
                headerRect = rect;
                EditorGUI.LabelField(rect, MenuConfig.GUI_WINDOW_PROJECT_TEXT_LIST_HEADER);
            };
        ...
        /// ウィンドウを開く
        /// </summary>
        [MenuItem(MenuConfig.TOOL_MENU_TEXT_OPEN_BOOKMARK_PROJECT)]
        static void Open()
        {
            var window = GetWindow<ProjectBookmarkWindow>();
            window.titleContent.text = MenuConfig.GUI_WINDOW_PROJECT_TEXT_TITLE;
            window.Repaint();
        }
        ...
        /// </summary>
        [MenuItem(MenuConfig.GUI_MENU_TEXT_REGISTER_PROJECT, false, 10001)]
        ...
        /// </summary>
        [MenuItem(MenuConfig.GUI_MENU_TEXT_REGISTER_PROJECT, true)]
